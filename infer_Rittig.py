...
def main(hyperparameter):
    ...
    for train_indices, val_indices in zip(train_indices_splits, val_indices_splits):
        ...
        if model_type == "SolvGNN":
            ...
            model = gegnn_binary(in_dim=74, hidden_dim=hidden_dim, n_classes=1, mlp_dropout_rate=mlp_dropout_rate, mlp_activation=mlp_activation, mlp_num_hid_layers=mlp_num_hid_layers).cuda()
