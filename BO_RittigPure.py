...
def objective(trial):
    ...
    GCN_layers = trial.suggest_categorical("GCN_layers", [1,2])
    MLP_layers = trial.suggest_categorical("MLP_layers", {1,2})
...
study = optuna.create_study(
    study_name="Test_RittigPure",
    direction="minimize",
    storage="sqlite:////home/kevinvergara/Physics-informed-Thermodynamics/TRIALS_BO_rittigPure.db",  # Checkpointing database
    load_if_exists=True,
    sampler=sampler
)
