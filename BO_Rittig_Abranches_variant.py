...
def train_and_evaluate(trial, gcn_dim, mpnn_dim, mlp_dim, learning_rate, batch_size, l2_coef, gpu_id):
    """
...
study = optuna.create_study(
    ...
    direction="minimize",
    storage="sqlite:////home/kevinvergara/Physics-informed-Thermodynamics/TRIALS_BO_rittig_abranches_database_variant.db",  # Checkpointing database
    load_if_exists=True,
    sampler=sampler
)
